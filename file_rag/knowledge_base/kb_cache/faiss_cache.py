...
from file_rag.knowledge_base.kb_cache.base import *
from file_rag.knowledge_base.utils import get_vs_path
from file_rag.server.utils import get_Embeddings, get_default_embedding
            ...
            if cache is None:
                ...
                with item.acquire(msg="初始化"):
                    ...
                    if os.path.isfile(os.path.join(vs_path, "index.faiss")):
                        embeddings = OllamaEmbeddings(model="bge-large-zh-v1.5:latest")
    ...
    def load_vector_store(
        ...
        if cache is None:
            ...
            with item.acquire(msg="初始化"):
                ...
                vs_path = get_vs_path(kb_name,"temp")
                if not os.path.exists(vs_path):
                            os.makedirs(vs_path)
                vector_store = self.new_temp_vector_store(embed_model=embed_model
                        )
