...
from file_rag.server.db.base import Base, engine
from file_rag.server.db.models.conversation_model import ConversationModel
from file_rag.server.db.models.message_model import MessageModel
from file_rag.server.db.repository.knowledge_file_repository import (
    add_file_to_db,
)

# ensure Models are imported
from file_rag.server.db.repository.knowledge_metadata_repository import (
    add_summary_to_db,
)
from file_rag.server.db.session import session_scope
from file_rag.knowledge_base.kb_service.base import (
    KBServiceFactory,
    SupportedVSType,
)
...
from file_rag.server.utils import get_default_embedding
