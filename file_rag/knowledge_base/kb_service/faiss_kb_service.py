...
from file_rag.knowledge_base.kb_cache.faiss_cache import (
    ThreadSafeFaiss,
    kb_faiss_pool,
)
from file_rag.knowledge_base.kb_service.base import KBService, SupportedVSType
from file_rag.knowledge_base.utils import KnowledgeFile, get_kb_path, get_vs_path
...
if __name__ == "__main__":
    ...
    faissService.add_doc(KnowledgeFile("【每日范文】干得好不好群众是主考.md", "test"))
    # faissService.delete_doc(KnowledgeFile("README.md", "test"))
    # faissService.do_drop_kb()
    docs = faissService.do_search("主要内容是", top_k=2)
    for doc in docs:
        print(f'doc------{doc}')
