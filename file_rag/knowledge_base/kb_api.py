...
from file_rag.knowledge_base.utils import validate_kb_name
from file_rag.server.utils import BaseResponse, ListResponse, get_default_embedding
...
def create_kb(
    ...
    if kb is not None:
        return BaseResponse(code=33, msg=f"已存在同名知识库 {knowledge_base_name}")
