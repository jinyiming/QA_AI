...
from sqlalchemy.types import VARCHAR, NVARCHAR, CHAR, \
    BLOB, CLOB, TIME, TIMESTAMP, FLOAT, BIGINT, DOUBLE, DECIMAL, \
     REAL, TIME
...
class DMDDLCompiler(compiler.DDLCompiler):
    ...
    #def sql_compiler(self):
        #self.dialect.trace_process('DMDDLCompiler', 'sql_compiler')
        #return super(DMDDLCompiler, self).sql_compiler()
        
    #def type_compiler(self):
        #self.dialect.trace_process('DMDDLCompiler', 'type_compiler')
        #return super(DMDDLCompiler, self).type_compiler()
