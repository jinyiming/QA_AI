...
from file_rag.server.agent.tools_factory.search_internet import search_engine
from file_rag.server.api_server.api_schemas import OpenAIChatOutput
from file_rag.server.chat.utils import History
from file_rag.knowledge_base.kb_service.base import KBServiceFactory
from file_rag.knowledge_base.kb_doc_api import search_docs, search_temp_docs
from file_rag.knowledge_base.utils import format_reference, format_reference1
        ...
        try:
            ...
            if mode == "local_kb":
                ...
                docs = await run_in_threadpool(search_temp_docs,
                                                ...
                                                score_threshold=score_threshold)
                print("docs:", docs)
                source_documents = format_reference1(kb_name, docs, api_address(is_public=True))
            ...
            import os
            langfuse_secret_key = os.environ.get('sk-lf-d9756e43-e388-4c1d-9f93-f853aa866871')
            langfuse_public_key = os.environ.get('pk-lf-e3c50e86-5305-4b85-af33-7cd5f53b08af')
            langfuse_host = os.environ.get('ll;')
            ...
            # print(await chain.ainvoke({"context": context, "question": query}))
            ...
            print("Yielding error:", error_response)
