...
def dialogue_page(
    ...
    <input type="text" id="selected-question" class="hidden-input">
    """, unsafe_allow_html=True)

    # 定义常用问题，颜色和图标
    common_questions = [
        ("我是谁？", "#FF6B6B", "fa-user"),
        ("我的个人信息是什么？", "#4ECDC4", "fa-id-card"),
        ("我的权限有哪些？", "#45B7D1", "fa-key"),
        ("如何使用这个系统？", "#F7B731", "fa-question-circle"),
        ("有哪些功能？", "#6C5CE7", "fa-list")
    ]

    # 修改浮动标签的HTML生成
    

    st.session_state.selected_question = None  # 初始化选中的问题
    for question, color, icon in common_questions:
        if st.button(question, key=question):
            st.session_state.selected_question = question

    # 在chat input部分之前，获取选中的问题
    # selected_value = st.text_input("Selected Question", key="selected_question", label_visibility="collapsed")
